...
public class SQLiteUtil {
    ...
    public static String getSQLConstant(SQL_CONSTANTS sqlConstant){
        switch (sqlConstant){
            case DATABASE_FILE_NAME: return DATABASE_FILE_NAME;
            case IMAGE_DATA_TABLE_NAME: return IMAGE_DATA_TABLE_NAME;
            case IMAGE_DATA_ID_HEADING: return IMAGE_DATA_ID_HEADING;
            case IMAGE_DATA_PRODUCT_CODE_HEADING: return IMAGE_DATA_PRODUCT_CODE_HEADING;
            case IMAGE_DATA_PRODUCT_WEB_CODE_HEADING: return IMAGE_DATA_PRODUCT_WEB_CODE_HEADING;
            case IMAGE_DATA_PRODUCT_NAME_HEADING: return IMAGE_DATA_PRODUCT_NAME_HEADING;
            default: return null;
        }
    }
